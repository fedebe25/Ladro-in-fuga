# Lezione 4 – nemici sparanti
# Obiettivo: ostacoli e nemici che sparano proiettili, gestione collisioni, spawn controllato
...
pygame.display.set_caption("Ladro in fuga - Lezione 3")
# TODO aggiornare titolo finestra → "Lezione 4 con vittoria e sconfitta"
...
# TODO aggiungere costante TEMPO_VITTORIA = 30000 (30 secondi in millisecondi)
...
VIOLA = (128, 0, 128)
NERO = (0, 0, 0)
# TODO aggiungere ARANCIONE = (255, 140, 0) e BIANCO = (255, 255, 255)
...
# TODO aggiungere font_grande = pygame.font.SysFont(None, 80) per scritte di vittoria/sconfitta
...
# TODO aggiungere variabili di stato per vittoria/sconfitta e tempo di inizio
...
while running:
    ...
    # TODO calcolare tempo_passato = ora - tempo_inizio
    ...
    # TODO aggiungere controllo condizioni di fine gioco

    # TODO racchiudere la logica di gioco (input, gravità, collisioni, nemici) in un if not vittoria and not sconfitta
    ...
    if not boss_attivo:
        ...
        # TODO aggiungere rigenerazione automatica degli ostacoli e delle monete quando escono dallo schermo
        ...
        # Attiva boss se punteggio sufficiente
    ...
    for p in proiettili_nemico:
        pygame.draw.rect(screen, (255, 140, 0), p["rect"])  # TODO: usare variabile ARANCIONE

    # Boss e suoi proiettili
    if boss_attivo:
    ...
    # TODO aggiungere schermate di fine gioco:
